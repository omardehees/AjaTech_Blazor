...
{
    public class Tbl_def_Modules_xService : ITbl_def_Modules_xService
    {
        //DataBase connection
        private readonly SqlConnectionConfiguration _configuration;
        public Tbl_def_Modules_xService(SqlConnectionConfiguration Configuration)
        {
        ...
        //Update row in Tbl_def_Modules_x Table -----------------------------------------------------------------------
        public async Task<bool> Tbl_def_Modules_xDelete(int ID)
        {
            using (var conn = new SqlConnection(_configuration.Value))
            {
                //Debug.WriteLine(">> " + conn.ConnectionString);
                ...
                await conn.ExecuteAsync("sp_Delete_Tbl_def_Modules_x", parameters, commandType: System.Data.CommandType.StoredProcedure);
            }
            return true;
        }
        // ----------------------------------------------------------------------- -----------------------------------
        //List Tbl_def_Modules_x Table        
        public async Task<IEnumerable<Tbl_def_Modules_x>> Tbl_def_Modules_xList()
        {
            IEnumerable<Tbl_def_Modules_x> tbl_def_Modules_xs;
            using (var conn = new SqlConnection(_configuration.Value))
            {
                try
                {
                    tbl_def_Modules_xs = conn.Query<Tbl_def_Modules_x>("sp_Select_Tbl_def_Modules_x", commandType: CommandType.StoredProcedure);
                    return tbl_def_Modules_xs;
                }
                catch (SqlException sqlEx)
                {
                    Debug.WriteLine("Errors SQl   : " + sqlEx.Message);
                    tbl_def_Modules_xs = await conn.QueryAsync<Tbl_def_Modules_x>("sp_Select_Tbl_def_Modules_x", commandType: CommandType.StoredProcedure);
                    return tbl_def_Modules_xs;
                }
                catch (Exception ex)
                {
        ...
        // ----------------------------------------------------------------------- -----------------------------------
        //One Tbl_def_Modules_x by ID        
        public Tbl_def_Modules_x Tbl_def_Modules_xOne(int ID)
        {
            Tbl_def_Modules_x tbl_def_Modules_x;
            using (var conn = new SqlConnection(_configuration.Value))
            {
                var parameters = new DynamicParameters();
                parameters.Add("ID", ID, DbType.Int32);
                string Querystring = "Select top(1) * from Tbl_def_Modules_x where ID=" + ID.ToString();
                Debug.WriteLine(Querystring);
                try
                {
                    tbl_def_Modules_x = conn.QuerySingle<Tbl_def_Modules_x>(Querystring, ID, commandType: CommandType.Text);
                    return tbl_def_Modules_x;
                }
                catch (SqlException sqlEx)
                {
                    Debug.WriteLine("Errors SQl   : " + sqlEx.Message);
                    tbl_def_Modules_x = conn.QuerySingle<Tbl_def_Modules_x>(Querystring, commandType: CommandType.Text);
                    return tbl_def_Modules_x;
                }
                catch (Exception ex)
                {
